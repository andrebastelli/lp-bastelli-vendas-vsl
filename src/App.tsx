  ...
  return (
    <section className="relative overflow-hidden bg-bastelli-navy text-white">
      ...
      <div className="relative mx-auto max-w-6xl px-5 pb-20 pt-14 md:px-8 md:pb-28 md:pt-20">
        ...
        {/* VSL — acima do CTA */}
        <div className="mx-auto mt-10 max-w-[340px] md:mt-14 md:max-w-[420px]">
          <VSLPlayer />
...
const VIMEO_VIDEO_ID = "1219266949";
const VSL_ASPECT_RATIO = "9/16";
  ...
  return (
    <div ref={anchorRef}>
      ...
      <div className="relative w-full overflow-hidden border border-white/15 shadow-[0_30px_80px_-40px_rgba(0,0,0,0.7)]">
        <div style={{ aspectRatio: VSL_ASPECT_RATIO }} className="relative w-full bg-black">
          <iframe
            src={embedSrc}
      ...
      {showFloating && (
        <div
          className="fixed bottom-4 right-4 z-50 w-[150px] overflow-hidden rounded-lg border border-white/20 bg-black shadow-2xl sm:w-[170px] md:w-[190px]"
          role="complementary"
          aria-label="Vídeo flutuante"
        >
          <div className="flex flex-col items-center justify-center gap-1 bg-bastelli-navy px-2 py-1.5 pr-8 text-[9px] uppercase tracking-[0.14em] text-white/50">
            <span className="inline-flex items-center gap-1.5 rounded-sm border border-orange-500/40 bg-orange-500/10 px-1.5 py-0.5 font-mono text-[9px] font-bold uppercase tracking-[0.14em] text-orange-400">
              <span className="relative inline-flex items-center justify-center">
                ...
                <span className="relative inline-flex items-center justify-center rounded-[3px] bg-orange-500 px-1 py-[1px]">
                  <svg viewBox="0 0 24 24" className="h-2 w-2 fill-white" aria-hidden="true">
