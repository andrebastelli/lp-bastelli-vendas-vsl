...
const CHECKOUT_URL =
  "https://pay.hotmart.com/P106827303T?off=elttqpev&checkoutMode=10";
              ...
              <div className="relative border border-dashed border-bastelli-navy/25 bg-white p-6 md:p-8">
                ...
                <dl className="mt-5 space-y-4 text-[13px] text-bastelli-navy">
                  ...
                  <div className="flex items-baseline justify-between gap-4">
                    ...
                    <dd className="text-right font-medium">Online</dd>
                  </div>
                  <div className="flex items-baseline justify-between gap-4">
                    <dt className="font-mono text-[11px] uppercase tracking-[0.18em] text-bastelli-navy/70">
                      Certificado
                ...
                <div className="mt-7 border-t border-dashed border-bastelli-navy/25 pt-6">
                  ...
                  <div className="flex justify-center">
                    <CTA className="w-full max-w-xs">Quero aproveitar a oferta</CTA>
                  </div>
